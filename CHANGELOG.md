...
- Add manual/automatic operation with bumpless return to automatic.
- Add deterministic first-order process modelling and closed-loop simulation.
- Add logging, Pandas/CSV export, response metrics, and visualization.
- Add reproducible gain experiments and P/PI/PID comparison.
